...
2. **Feature documentation** — each proto file is an authoritative, executable illustration of how to use a particular set of annotations.
...
3. Compares the output against the reference JSON/YAML files stored in `src/<suite>/resources/`.
